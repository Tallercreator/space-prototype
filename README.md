...
Прототипы на дизайн-системе `@otp/space-ui-kit`. Сейчас здесь «Цифровой оффер»
(контур кандидата) — см. `PROTOTYPE-NOTES.md`: сценарии, хэши, расхождения с макетом.

Прототип Живёт только в этом
