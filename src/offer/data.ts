...
export const salary = {
  total: "103 456 ₽",
  totalCaption: "Ежемесячный доход, согласно условиям\nТрудового договора с учётом надбавок и компенсаций",
  bonus: { value: "15%", caption: "Квартальная премия" },
...
export type Condition = { label: string; icon?: ConditionIcon } & ({ value: string; items?: never } | { items: string[]; value?: never });
