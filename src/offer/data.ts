...
export const salary = {
  ...
  /** Слагаемые сходятся в total: 64 108 + 15 700 + 23 648 = 103 456. */
  parts: [
    { value: "64 108 ₽", caption: "фиксированный оклад" },
    { value: "15 700 ₽", caption: "гарант новичка", note: "на первые 3 месяца" },
    { value: "23 648 ₽", caption: "северная надбавка" },
  ],
};
