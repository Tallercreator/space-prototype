...
export const positions: Record<OfferKind, { title: string; department: string }> = {
  ...
  pdf: {
    title: "Руководителя направления",
    department: "Департамент розничных рисков",
  },
};
...
export const salary = {
  ...
  newcomer: { value: "15 700 ₽", caption: "Гарант новичка на первые 3 месяца" },
  breakdownTitle: "Из чего складывается твоя заработная плата",
  parts: [
    { value: "64 108 ₽", caption: "фиксированный оклад" },
    { value: "15 700 ₽", caption: "надбавка за объем работ" },
    { value: "15 700 ₽", caption: "гарант новичка" },
    { value: "7 948 ₽", caption: "адм. премия" },
  ],
  coefficients: [
    { value: "0,03", caption: "северная надбавка" },
    { value: "1,5", caption: "региональный коэффициент" },
  ],
};
